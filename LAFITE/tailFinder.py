# AUTOGENERATED! DO NOT EDIT! File to edit: ../04_tailfinder.ipynb.

# %% auto 0
__all__ = ['AlternativeTerminalFinder', 'TailFinderWrapper']

# %% ../04_tailfinder.ipynb 2
import warnings
import pandas as pd
...
class AlternativeTerminalFinder:
	...
	def terminal_cluster(self):
		outlist = [self.chrom, self.strand, self.corrected_read_splicing, self.fsm, self.count, self.polya_count, self.collapsed_ID,self.reference_id]
...
class TailFinderWrapper:
	...
	def result_collection(self):
		...
		for result in results_lst:
			...
			processed_collected_multi_exon_read[(chrom, strand)][corrected_read_splicing] = [start, end, total_count, polya_count, fsm, polya_tag, as_site, apa_site, collapsed_ID, reference_id]
